---
page_type: sample
description: This sample demonstrates how to use multiple parameters in a plugin for Microsoft 365 Copilot using JavaScript and Teams Toolkit for Visual Studio Code.
products:
- office-teams
- copilot-m365
languages:
...
# Using multiple parameters in a plugin for Microsoft 365 Copilot using JavaScript and Teams Toolkit for Visual Studio Code sample
